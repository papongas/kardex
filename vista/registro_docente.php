...
<div class="page-content">
    ...
    <h4 class="text-center text-secondary">AGREGAR UN NUEVO DOCENTE</h4>
    <?php
    include "../modelo/conexion.php";
    include "../controlador/registrar_docente.php";
    ...
    <div class="row">
        <form action="" method="POST">
            ...
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
                <input type="text" placeholder="Materia" class="input input__text" name="txtMateria">
            </div>
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
                <input type="text" placeholder="Sueldo" class="input input__text" name="txtSueldo">
            </div>
            <div class="fl-flex-label mb-4 px-2 col-12 col-md-6">
