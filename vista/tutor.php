...
<div class="page-content">
    ...
    <h4 class="text-center text-secondary">TUTORES</h4>
    
    <?php
    include "../modelo/conexion.php";
    include "../controlador/modificar_tutor.php";
    include "../controlador/eliminar_tutor.php";

    
    $sql=$conexion->query(" SELECT * from tutor ");
    ?>


    <a href="registro_tutor.php" class="btn btn-primary btn-rounded mb-3"><i class="fa-solid fa-plus"></i> &nbsp;Agregar</a>
        ...
        <tbody>
            ...
            while($datos = $sql->fetch_object()) { ?>
                <tr>
                    ...
                    <td>
                        <a href="" data-toggle="modal" data-target="#exampleModal<?= $datos->id_tutor ?>"  class="btn btn-warning btn-sm"><i class="fa-solid fa-pen-to-square "></i></a>
                        <a href="tutor.php?id=<?= $datos->id_tutor?>" onclick="advertencia(event)" class="btn btn-danger btn-sm"><i class="fa-solid fa-trash"></i></a>
                    </td>
                    </tr>
                    
                    <!-- Modal -->
                    
                    <div class="modal fade" id="exampleModal<?= $datos->id_tutor ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <div class="modal-content">
                        <div class="modal-header d-flex justify-content-between">
                            <h5 class="modal-title w-100" id="exampleModalLabel" >EDITAR TUTOR</h5>
                        ...
                        <div class="modal-body">
                            <form action="" method="POST">
                                <div hidden class="fl-flex-label mb-4 px-2 col-12 col">
                                    <input type="text" placeholder="Id" class="input input__text" name="txtid" value="<?= $datos->id_tutor ?>">
                                </div>
